...
//void Application::create(const Settings& settings) {
    ...
    //// Load all the game resources here for now..
    //loader.queue<Texture>("assets/textures/texture-0.png", "tex0");
    //loader.queue<Texture>("assets/textures/texture-1.png", "tex1");
    //loader.queue<Texture>("assets/textures/texture-2.png", "tex2");
    //loader.queue<Texture>("assets/textures/texture-3.png", "tex3");
    //loader.queue<Texture>("assets/textures/texture-4.png", "tex4");
    //loader.queue<Texture>("assets/textures/texture-5.png", "tex5");
    //loader.queue<Texture>("assets/textures/texture-6.png", "tex6");
    //loader.queue<Texture>("assets/textures/texture-7.png", "tex7");
    //loader.loadAll();

    //window.create(settings.width, settings.height, settings.fullscreen);
    //graphics.create(window, settings.vsync);
    //map.create(&player, &loader, settings.mapFile);
